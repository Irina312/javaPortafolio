...
public class Range {
	public static void main(String[] args) {
		// create a static method that will accept one int number as an argument
		// if number is within 7 - 14, print "Within a range"
		// if number is out of 7 - 14, print "Out of range"
