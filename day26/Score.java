...
public class Score {
	public static void main(String[] args) {
		...
		// score[5] = 100; ArrayIndexOUtOfBondExeption
		// System.out.println(score[5]); ArrayIndexOutOfBondExeption
		
		// Assign first element of array score to the sum of last & second
