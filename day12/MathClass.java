...
public class MathClass {
	public static void main(String[] args) {
		// Math.abs() - method returns the absolute(positive) value of its argument
		...
		// Math.ceil() - method returns a decimal point value up to nearest integer
		// value
		// and it will round up
		double ceil = 3.01;
		System.out.println("ceil: " + ceil); // ceil: 3.01

		ceil = Math.ceil(ceil);
		System.out.println("after the Math.ceil(): " + ceil); // after the Math.ceil: 4.0
		...
		// Math.round() - will round decimal point number
		double rNum = 5.5;
